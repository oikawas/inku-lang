...
This guide defines the administration baseline for the unreleased inku v2.11.5 (Web Build 861). It covers the environment template, current DB schema, Web administration UI, and reference systemd templates.
