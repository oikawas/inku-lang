...
export const en: LangPack = {
	...
	variationGridDefault: '4 candidates',
	variationGridWithInterpretation: 'include interpretation',
	variationGridSaveSelected: 'keep selected',
	variationGridEmpty: 'select candidates first',
	tooltipVariationGridDefault: 'Generate two alternate performances and two alternate compositions from the same interpretation.',
	tooltipVariationGridWithInterpretation: 'Add a fresh Stage 1 interpretation candidate to the four-candidate grid.',
	tooltipVariationGridSaveSelected: 'Save selected candidates to history so they can be starred and annotated with a choice note.',
	...
	tooltipDdlAutoRepair: 'Apply deterministic repair to the Stage 2 JSON Score for invisible colors, over-density, and contract violations.',
	...
	tooltipCanvasVaryPerformance: 'Redraw with different noise and texture seeds, composition remains same',
	tooltipCanvasVaryComposition: 'Select different composition family and layout family, keeps normalized DDL',
	tooltipCanvasVaryInterpretation: 'Rerun Stage 1 interpretation to create a new normalized DDL',
