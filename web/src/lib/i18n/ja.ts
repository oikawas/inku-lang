...
export const ja: LangPack = {
	...
	settingsModelSecurityNote: 'APIキーはサーバー側DBにのみ保存され、画面には再表示されません。環境変数で設定済みのキーも初期値として扱われます。',
	...
	settingsExportTemplatesDescription: 'ステータスバーのPNGメニューに表示する保存形式を管理します。y軸高さをピクセル数で指定します。',
	settingsExportTemplateName: 'テンプレート名',
	settingsExportTemplateDescription: '説明',
	settingsExportTemplateHeight: 'y軸高さ',
