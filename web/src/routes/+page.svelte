...
<script lang="ts">
	...
	function saijikiPreview(categoryKey: string, canonicalWord: string, word: string, wordLang: ResolvedInstructionLang): SaijikiPreview {
		...
		const previews: Record<string, PreviewEntry> = {
			...
			交互に: { effect: '二つの値を交互に繰り返す。', example: '赤と灰を交互にして、円を五つ並べる。', effectEn: 'Repeats two values in alternation.', exampleEn: 'line up five circles, alternating red and gray.', svg: shapeSvg('<circle cx="42" cy="46" r="11" fill="#c9362d"/><circle cx="66" cy="46" r="11" fill="#777777"/><circle cx="90" cy="46" r="11" fill="#c9362d"/><circle cx="114" cy="46" r="11" fill="#777777"/><circle cx="138" cy="46" r="11" fill="#c9362d"/>') },
			順に: { effect: '列の順を保って繰り返す。', example: '赤・灰・青の順に繰り返して、円を八つ並べる。', effectEn: 'Repeats a listed order without changing it.', exampleEn: 'line up eight circles, repeating red, gray, and blue in order.', svg: shapeSvg('<circle cx="30" cy="46" r="9" fill="#c9362d"/><circle cx="47" cy="46" r="9" fill="#777777"/><circle cx="64" cy="46" r="9" fill="#2c5fb8"/><circle cx="81" cy="46" r="9" fill="#c9362d"/><circle cx="98" cy="46" r="9" fill="#777777"/><circle cx="115" cy="46" r="9" fill="#2c5fb8"/><circle cx="132" cy="46" r="9" fill="#c9362d"/><circle cx="149" cy="46" r="9" fill="#777777"/>') },
