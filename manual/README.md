...
This directory contains the Japanese and English manuals for the unreleased inku v2.13.19 baseline (Web Build 906).
...
Each language folder includes matching operational templates under `templates/`. `SPEC.ja.md` remains the canonical product specification; manuals explain supported use and operation without replacing that specification.
