...
| TEST-CORPUS | 凍結コーパス | render 37の597件、DDL 20の49件を再生成照合 | `server/reference/render-engine-37/manifest.json`; `ddl-engine-20/manifest.json`; workflow | §11, §22 | 確認済み | 公開可 |
