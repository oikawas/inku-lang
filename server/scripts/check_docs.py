...
PAIRS: tuple[tuple[str, str, str, str | None], ...] = (
    ...
    (
        ...
        "stages 4c-3 and 4c-4 write the rest. Stage 4c-1 wrote §13 and stage "
        "4c-2 wrote §4, §8 and §9, and stage 4c-3 wrote §7 and §14, so what "
        "English is still missing is §10 (quality and error handling, "
        "assigned to stage 4c-4 by the 2026-07-28 ruling), §15 and §17 (the "
        "development policy and the open-items list, which are deliberately "
        "out of scope). English also carries one subsection the Japanese does "
        "not, §7.8, which holds what the reference web application actually "
        "provides. (2) The operational "
