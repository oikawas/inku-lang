...
object InkuStringsEn : InkuStrings {
    ...
    override val cameraOverwriteBody = "If local image analysis succeeds, it replaces the current description and interpretation. Cancelling image input keeps them."
    ...
    override val cameraAnalyzingLocally = "Analyzing locally"
    override val cameraVisionModeTitle = "Camera analysis"
    override val cameraVisionModeSubtitle = "Direct DDL is an advanced mode. It creates DDL on-device and skips NIM Stage 1."
    ...
    override val cameraModelNotReady = "Local Gemma 4 E2B is not ready. Download it from Models in Settings."
    ...
    override val cameraAnalysisFailed = "Local image analysis failed"
    override val cameraEmptyResult = "Local image analysis returned no description"
    override val cameraInvalidDdl = "The on-device model did not produce valid DDL. Choose another image."
    override val cameraNimNotReady = "NVIDIA NIM is not configured"
    override val cameraNimFailed = "Development with NVIDIA NIM failed. You can retry with the retained description."
    override val cameraNimFailedDirectDdl = "Development with NVIDIA NIM failed. You can retry Stage 2 with the retained on-device DDL."
