...
開発上は、古いエンジンとの比較をしながら、常に進めています。版木は戻せませんが、刷りは残せます。世代が上がるたびに、決まった入力から得た出力の実物を凍結して、比較可能としています（`server/reference/`、現在 610 ケース）。**どの版が何をどう変えたかは [render engine の版史](docs/spec/render-engine-history.ja.md) にあります。**
