...
export const en: LangPack = {
	...
	tooltipCanvasTabCompare: 'Compare with previous work and compare drawings made through different inference models',
	...
	modelCompareSubtitle: 'Reread the input with up to four selected Stage 1 inference models, then compare drawings and normalized DDL.',
	...
	compareHistoryTitle: 'Compare previous and current work',
	compareHistorySubtitle: 'Place the current work beside the previous history item and review the prompt diff.',
	compareHistoryEmpty: 'No previous work is available to compare yet.',
