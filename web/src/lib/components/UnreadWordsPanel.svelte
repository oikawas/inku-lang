...
<style>
	...
	.popover-group-label { font-size: var(--ui-font-size-10); color: var(--fg3); text-transform: uppercase; letter-spacing: 0.08em; font-weight: 500; margin-bottom: 0; }
	.purpose-help { width: 17px; height: 17px; padding: 0; border: 1px solid var(--border2); border-radius: 50%; background: transparent; color: var(--fg3); font: 600 var(--ui-font-size-10)/1 inherit; cursor: help; }
	.purpose-help:hover, .purpose-help:focus-visible { color: var(--fg); border-color: var(--fg2); outline: none; }
	.unread-note { color: var(--fg2); font-size: var(--ui-font-size-12); line-height: 1.55; }
	...
	.scope-toggle button { border: 0; border-right: 1px solid var(--border2); padding: 5px 9px; background: var(--panel); color: var(--fg2); cursor: pointer; font: inherit; font-size: var(--ui-font-size-12); }
	.scope-toggle button:last-child { border-right: 0; }
	.scope-toggle button.active { background: var(--accent); color: var(--bg); }
	.inline-message { color: var(--fg2); font-size: var(--ui-font-size-12); padding: 12px 0; }
	.inline-message.error { color: var(--danger, #b33); }
	.unread-count { color: var(--fg3); font-size: var(--ui-font-size-11); margin-bottom: 6px; text-align: right; }
	.unread-table-wrap { overflow: auto; max-height: 55vh; border: 1px solid var(--border); border-radius: var(--r); }
	table { width: 100%; border-collapse: collapse; font-size: var(--ui-font-size-12); }
