...
| TEST-CORPUS | 凍結コーパス | render 34の588件、DDL 19の49件を再生成照合 | `server/reference/render-engine-34/manifest.json`; `ddl-engine-19/manifest.json`; workflow | §11, §22 | 確認済み | 公開可 |
