...
This guide describes a standard new installation or upgrade of the unreleased inku v2.11.12 (Web Build 868) on Linux. It provides both the existing systemd development setup and a Compose setup using the production SvelteKit adapter. Put a TLS reverse proxy in front of any public internet deployment.
