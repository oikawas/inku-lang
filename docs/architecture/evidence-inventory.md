...
| TEST-CORPUS | Frozen corpora | Rebuild and compare 582 Render Engine 32 cases and 45 DDL Engine 15 cases | `server/reference/render-engine-32/manifest.json`; `ddl-engine-15/manifest.json`; workflow | §11, §22 | Confirmed |
