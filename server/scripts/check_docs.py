...
PAIRS: tuple[tuple[str, str, str, str | None], ...] = (
    ...
    (
        ...
        "4c-2 wrote §4, §8 and §9, so what English is still missing is §10 "
        "(quality and error handling, which no stage has claimed yet), §15 "
        "and §17 (the development policy and the open-items list, which are "
        "deliberately out of scope). (2) The operational "
