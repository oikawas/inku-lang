...
| TEST-CORPUS | Frozen corpora | Rebuild and compare 569 Render Engine 31 cases and 42 DDL Engine 14 cases | `server/reference/render-engine-31/manifest.json`; `ddl-engine-14/manifest.json`; workflow | §11, §22 | Confirmed |
