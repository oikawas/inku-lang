...
| API route/model | 105 route（静的数え上げ）、公開3、response shape | `api.py`, `api_core/*`, `pipeline_api.py` | route auth、module split、API surface baseline | なし | Web/CLI/Android sender census。件数定数とbaselineの更新（`known-differences.ja.md` F-06） |
