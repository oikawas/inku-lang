...
Either method may include variation (§12.13) among the enabled refinement elements (up to five). Variation generations fix the amplitude to medium and use server-issued seeds.
