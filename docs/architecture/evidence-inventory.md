...
| TEST-CORPUS | Frozen corpora | Rebuild and compare 569 Render Engine 31 cases and 45 DDL Engine 15 cases | `server/reference/render-engine-31/manifest.json`; `ddl-engine-15/manifest.json`; workflow | §11, §22 | Confirmed |
