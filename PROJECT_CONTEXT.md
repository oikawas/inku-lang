...
**Target version: v2.4.3 / Build 693**
...
The Android app (`android/`; Kotlin + Compose + Room, running the whole pipeline on the device) reached **render engine 10 at `2.0.0-android.1` / Build 148077** (2026-07-23). It has its own version namespace, with `android/VERSION` and `android/BUILD_NUMBER` as the canonical files. The port follows the server, which stays canonical — **server-side design is not bent to suit Android**. See the Android entry in the changelog and `android/ANDROID_SPEC.md`.
