...
This guide defines the administration baseline for the unreleased inku v2.13.9 (Web Build 894). It covers the environment template, current DB schema, Web administration UI, and reference systemd templates.
