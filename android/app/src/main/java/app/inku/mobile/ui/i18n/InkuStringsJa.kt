...
object InkuStringsJa : InkuStrings {
    ...
    override val cameraVisionModeSubtitle = "DDL直接は上級モードです。記述生成モデルがDDLを作り、Stage 1を省略します。"
    ...
    override val cameraInvalidDdl = "有効なDDLを作れませんでした。画像を選び直してください。"
    override val cameraDrawModelNotReady = "描画モデルの設定が完了していません"
    override val cameraDrawFailed = "現像に失敗しました。記述を保ったまま再試行できます。"
    override val cameraDrawFailedDirectDdl = "現像に失敗しました。作ったDDLを保ったままStage 2から再試行できます。"
