...
| TEST-CORPUS | Frozen corpora | Rebuild and compare 569 Render Engine 31 cases and 40 DDL Engine 13 cases | `server/reference/render-engine-31/manifest.json`; `ddl-engine-13/manifest.json`; workflow | §11, §22 | Confirmed |
