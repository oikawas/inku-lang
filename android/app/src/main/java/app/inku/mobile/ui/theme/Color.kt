...
val CameraDevelopmentVividCyan = Color(0xFF00E2D3)
val CameraDevelopmentVividRed = Color(0xFFFF4356)
val CameraDevelopmentVividBlue = Color(0xFF4A73FF)
val CameraDevelopmentVividLime = Color(0xFFB8FF3B)
