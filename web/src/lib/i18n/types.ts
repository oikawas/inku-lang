...
export interface LangPack {
	...
	settingsTextSizeLabel: string;
	settingsTextSizeDescription: string;
	settingsTextSizeSmallEnd: string;
	settingsTextSizeLargeEnd: string;
	settingsTextSizeValue: (percent: number, label: string) => string;
	settingsTextSizeVerySmall: string;
	settingsTextSizeStandard: string;
	settingsTextSizeLarge: string;
	settingsTextSizeVeryLarge: string;
	settingsTextSizeLargest: string;
	settingsTextSizeReset: string;
	settingsTextSizeSaving: string;
	settingsTextSizeSaveFailed: string;
	...
	settingsExportNavDestination: string;
	settingsExportNavPng: string;
	settingsExportNavAnimation: string;
	settingsExportAnimationLayer: string;
	settingsExportAnimationTransition: string;
	settingsExportNavCard: string;
	settingsExportBrowserScope: string;
	settingsExportAccountScope: string;
	settingsExportTemplateSave: string;
	settingsExportTemplateReset: string;
	settingsExportTemplateUnsaved: string;
	settingsExportTemplateNameRequired: string;
	settingsExportTemplateHeightRange: string;
	settingsExportDefaultScope: string;
	settingsDownloadFolderUnavailable: string;
	userSearchPlaceholder: string;
	userFilterAll: string;
	userFilterNoGroup: string;
	userDraftChanges: string;
	userPermissionGroupsHint: string;
	userGroupMembershipHint: string;
	userAddOpen: string;
	userNoSearchResults: string;
	settingsRenderLimitsCurrent: string;
	settingsRenderLimitsDefault: string;
	settingsRenderLimitsUnit: (unit: string) => string;
	settingsRenderLimitUnits: Record<string, string>;
	settingsRenderLimitsChanges: (count: number) => string;
	settingsRenderLimitsSave: string;
	settingsRenderLimitsCancel: string;
	settingsRenderLimitsSaving: string;
	settingsRenderLimitsNormalized: (fields: string) => string;
	settingsRenderLimitGroupSummaries: Record<string, string>;
