...
| TEST-CORPUS | 凍結コーパス | render 31の569件、DDL 15の45件を再生成照合 | `server/reference/render-engine-31/manifest.json`; `ddl-engine-15/manifest.json`; workflow | §11, §22 | 確認済み | 公開可 |
