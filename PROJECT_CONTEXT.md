...
**Target version: v2.13.6 / Build 891**
...
| Render Engine | 30 | `server/src/inku_server/render_engines/default.py` |
...
- **Render Engine 30** — the SVG performance.
...
`render-engine-30` (553 cases) and `ddl-engine-13` (40 cases) are current, and CI enforces
