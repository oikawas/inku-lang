...
| TEST-CORPUS | 凍結コーパス | render 29の549件、DDL 13の40件を再生成照合 | `server/reference/render-engine-29/manifest.json`; `ddl-engine-13/manifest.json`; workflow | §11, §22 | 確認済み | 公開可 |
