...
This manual explains how to use and operate the unreleased inku v2.11.5 baseline (Web Build 861). It is intended for first-time creators and system administrators who deploy and maintain the application. The canonical product specification is `SPEC.ja.md` at the repository root.
