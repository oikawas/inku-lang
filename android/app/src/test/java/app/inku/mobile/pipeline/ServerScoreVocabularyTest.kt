...
class ServerScoreVocabularyTest {
    ...
    @Test
    fun testTheSchemaOffersScore0_6AndKeepsOldEditions() {
        val root = JSONObject(ServerScoreSchemaJson.parameters)
        val properties = root.getJSONObject("properties")
        assertEquals("0.6.0", properties.getJSONObject("version").getString("default"))
        assertEquals("[\"0.6.0\",\"0.5.0\",\"0.4.0\",\"0.3.0\",\"0.2.0\",\"0.1.0\"]",
