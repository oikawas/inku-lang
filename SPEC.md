...
Object size uses the canvas short edge independently of count, cells, or density. The principle covers all shapes; delivered plans currently support line, circle, ellipse, square, arc, cloudform, and point. Normal width or diameter is 6/25; ellipse / cloudform height is 3/5 of width, arc sagitta is 3/50, and point diameter is 3/250. Existing size factors and shape-specific anchors remain, and thinness does not change outer size. A large circle keeps diameter 9/25 at both four and eight objects, allowing overlap. Numeric geometry retains its exact decimal / Rational, basis, dimension, and provenance. Triangle and Polygon remain explicit gaps with their identity and owner.
