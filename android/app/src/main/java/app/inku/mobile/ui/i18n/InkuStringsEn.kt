...
object InkuStringsEn : InkuStrings {
    ...
    override val cameraOverwriteBody = "If local analysis succeeds after the photo, it replaces the current description and interpretation. Cancelling the photo keeps them."
    override val cameraOverwriteAction = "Take photo"
    ...
    override val cameraCancelled = "Photo cancelled"
    ...
    override val cameraDecodeFailed = "The captured image could not be prepared"
    ...
    override val cameraInvalidDdl = "The on-device model did not produce valid DDL. Take another photo."
