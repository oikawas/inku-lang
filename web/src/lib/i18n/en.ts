...
export const en: LangPack = {
	...
	modelCompareSubtitle: 'Place drawings and normalized DDL from up to four selected Stage 1 inference models to the right of the target work.',
	...
	modelCompareDrawingBody: 'Reading and drawing with the selected inference models.',
