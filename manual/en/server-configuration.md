...
This guide defines the administration baseline for the unreleased inku v2.13.1 (Web Build 885). It covers the environment template, current DB schema, Web administration UI, and reference systemd templates.
