...
**Target version: v2.13.18 / Build 905**
...
| DDL | `ddl_version` 3 / `ddl_engine_version` 16 | `server/src/inku_server/layer_versions.py` |
| Android | `2.1.4-android.27` | `android/VERSION` (a namespace separate from web and server) |
