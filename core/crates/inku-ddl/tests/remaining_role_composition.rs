...
const FIXTURE: &str = include_str!("fixtures/remaining-role-composition-v3.json");
...
fn fixture_schema_ids_and_required_boundaries_are_guarded() {
    ...
    assert_eq!(
        ...
        "inku.remaining-role-composition.v3"
    );
    assert_eq!(fixture.schema, "inku.remaining-role-composition-fixture.v3");
