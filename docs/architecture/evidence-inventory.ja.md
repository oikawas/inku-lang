...
| TEST-CORPUS | 凍結コーパス | render 30の553件、DDL 13の40件を再生成照合 | `server/reference/render-engine-30/manifest.json`; `ddl-engine-13/manifest.json`; workflow | §11, §22 | 確認済み | 公開可 |
