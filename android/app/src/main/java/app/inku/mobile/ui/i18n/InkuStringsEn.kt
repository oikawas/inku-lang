...
object InkuStringsEn : InkuStrings {
    ...
    override val cameraTakePhoto = "Take a photo"
    ...
    override val cameraLoadingLocalModel = "Loading local model"
    override val cameraAnalyzingLocally = "Analyzing the image"
    override val cameraVisionModeTitle = "Camera analysis"
    override val cameraVisionModeSubtitle = "Direct DDL is an advanced mode. The description model writes DDL and Stage 1 is skipped."
    ...
    override val cameraModelNotReady = "The on-device description model is not ready. Download it from Models in Settings, or choose another description model."
    override val cameraCaptureUnavailable = "The camera could not be opened"
    override val cameraPhotoPickerUnavailable = "Photo selection could not be opened"
    override val cameraEmptyImage = "No captured image was received"
    override val cameraDecodeFailed = "The image could not be prepared"
    override val cameraAnalysisFailed = "Image analysis failed"
    override val cameraEmptyResult = "Image analysis returned no description"
    override val cameraInvalidDdl = "The model did not produce valid DDL. Choose another image."
    override val cameraDrawModelNotReady = "The drawing model is not configured"
    override val cameraDrawFailed = "Development failed. You can retry with the retained description."
    override val cameraDrawFailedDirectDdl = "Development failed. You can retry Stage 2 with the retained DDL."
    ...
    override val generationInfoSketchSection = "Sketch from life"
    override val generationInfoInterpretationSection = "Interpretation"
    override val generationInfoPerformanceSection = "Performance"
    override val generationInfoIdentitySection = "Identity"
    override val generationInfoRunSection = "Run"
    override val generationInfoInputOrigin = "Origin"
    override val generationInfoInputRoute = "Route"
    override val generationInfoVisionProvider = "Vision provider"
    override val generationInfoVisionModel = "Vision model"
    override val generationInfoVisionPromptVersion = "Observation version"
    override val generationInfoVisionOutputMode = "Output mode"
    override val generationInfoNormalizedImageDimensions = "Normalized capture size"
    override val generationInfoInputOriginCamera = "Camera"
    override val generationInfoInputOriginPhotoPicker = "Existing photo"
    override val generationInfoInputRouteLocalDescriptionToNim = "Local description → NIM"
    override val generationInfoInputRouteLocalDdlToNimStage2 = "Local DDL → NIM Stage 2"
    override val generationInfoInputRouteDescriptionToPipeline = "Photo description → drawing settings"
    override val generationInfoInputRouteDdlToPipelineStage2 = "Photo DDL → drawing settings Stage 2"
    override val generationInfoVisionOutputModeDescription = "Description"
    override val generationInfoVisionOutputModeDdl = "DDL"
    override val generationInfoSketchGrain = "Grain"
    override val generationInfoSketchState = "What the record says"
    override val generationInfoStage1Model = "Stage 1 model"
    override val generationInfoStage2Model = "Stage 2 model"
    ...
    override val generationInfoCreated = "Created"
