...
This guide defines the administration baseline for the unreleased inku v2.11.8 (Web Build 864). It covers the environment template, current DB schema, Web administration UI, and reference systemd templates.
