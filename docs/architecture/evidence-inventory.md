...
| TEST-CORPUS | Frozen corpora | Rebuild and compare 597 Render Engine 37 cases and 49 DDL Engine 20 cases | `server/reference/render-engine-37/manifest.json`; `ddl-engine-20/manifest.json`; workflow | §11, §22 | Confirmed |
