...
| TEST-CORPUS | Frozen corpora | Rebuild and compare 549 Render Engine 29 cases and 36 DDL Engine 12 cases | `server/reference/render-engine-29/manifest.json`; `ddl-engine-11/manifest.json`; workflow | §11, §22 | Confirmed |
