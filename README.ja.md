...
主に、以下の三つのアイディアを起点にしています。

| アイディアの基 | inku が参考にしたこと |
|---|---|
| **Sol LeWitt の指示書** | 記述そのものが作品であるという思想。記述とドローイングの役割分離。アプリケーションの発想のもとになったコンセプト |
| **盆栽** | 無制限の語彙/スペックは、描き手を制約する。限られた選択肢が、よりよい創造を生む |
| **短歌** | どのような文章をターゲットに考えるか、どんな伝統に依拠するのが良いのか |
...
4. 固定した大きさを持たない——座標は絶対寸法を持たず、あらゆる媒体にスケール可能。縦横比も固定しない
...
作品は既定では書いた人のものだが、**相手と権限を選んで 1 件ずつ共有できる**
