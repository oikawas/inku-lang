...
PAIRS: tuple[tuple[str, str, str, str | None], ...] = (
    ...
    (
        ...
        "close. (1) Some concept sections still exist only in Japanese; "
        "stage 4c-4 writes the rest. Stage 4c-1 wrote §13, stage 4c-2 wrote "
        "§4, §8 and §9, stage 4c-3 wrote §7 and §14, and stage 4c-4a wrote "
        "§10 and rebuilt §5 and §6 into the Japanese subsection structure. "
        "What English is still missing is the concept half of §12 (the "
        "two-stage architecture: English holds four subsections against the "
        "Japanese thirteen, assigned to stage 4c-4b), plus §15 and §17 (the "
        "development policy and the open-items list, which are deliberately "
        "out of scope). English also carries two subsections the Japanese "
        "does not: §7.8, which holds what the reference web application "
        "actually provides, and §6.7, which records what the English "
        "instruction path does and how it was measured. (2) The operational "
