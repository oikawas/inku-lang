...
object InkuStringsJa : InkuStrings {
    ...
    override val cameraOverwriteBody = "撮影後のローカル解析が成功すると、現在の記述と解釈は置き換わります。撮影を取り消した場合は残ります。"
    override val cameraOverwriteAction = "撮影する"
    ...
    override val cameraCancelled = "撮影を取り消しました"
    ...
    override val cameraDecodeFailed = "撮影画像を準備できませんでした"
    override val cameraAnalysisFailed = "端末内の画像解析に失敗しました"
    override val cameraEmptyResult = "端末内の画像解析結果が空でした"
    override val cameraInvalidDdl = "端末内で有効なDDLを作れませんでした。撮り直してください。"
