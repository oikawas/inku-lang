...
| API route/model | 107 route、公開3、response shape | `api.py`, `api_core/*`, `pipeline_api.py` | route auth、module split、API surface baseline | なし | Web/CLI/Android sender census。route・schemaが変わったら件数定数を直し、baselineをlive appから作り直す |
