...
This guide defines the administration baseline for the unreleased inku v2.13.4 (Web Build 888). It covers the environment template, current DB schema, Web administration UI, and reference systemd templates.
